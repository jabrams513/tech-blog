...
// Route to render the user's dashboard with their posts and associated comments and users
router.get("/", withAuth, async (req, res) => {
  try {
    // Fetch posts of the authenticated user with associated comments and users
...
router.get("/edit/:id", withAuth, async (req, res) => {
  try {
    // Fetch a specific post with associated comments and users
